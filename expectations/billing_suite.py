...
suite.add_expectation(
    gx.expectations.ExpectColumnMinToBeBetween(
        meta={"check_id": "contract:billing_history:id:min"},
        column="id",
        min_value=1,
    )
)
...
suite.add_expectation(
    gx.expectations.ExpectColumnToExist(
        meta={"check_id": "contract:billing_history:billAmount:exists"},
        column="billAmount",
    )
)
suite.add_expectation(
    gx.expectations.ExpectColumnValueLengthsToBeBetween(
        meta={"check_id": "contract:billing_history:billAmount:max_length"},
        column="billAmount",
        max_value=200,
    )
)
...
suite.add_expectation(
    gx.expectations.ExpectColumnToExist(
        meta={"check_id": "contract:billing_history:billPerformer:exists"},
        column="billPerformer",
    )
)
suite.add_expectation(
    gx.expectations.ExpectColumnValueLengthsToBeBetween(
        meta={"check_id": "contract:billing_history:billPerformer:max_length"},
        column="billPerformer",
        max_value=200,
    )
)
...
suite.add_expectation(
    gx.expectations.ExpectColumnToExist(
        meta={"check_id": "contract:billing_history:billReason:exists"},
        column="billReason",
    )
)
suite.add_expectation(
    gx.expectations.ExpectColumnValueLengthsToBeBetween(
        meta={"check_id": "contract:billing_history:billReason:max_length"},
        column="billReason",
        max_value=200,
    )
)
...
suite.add_expectation(
    gx.expectations.ExpectColumnToExist(
        meta={"check_id": "contract:billing_history:notes:exists"},
        column="notes",
    )
)
suite.add_expectation(
    gx.expectations.ExpectColumnValueLengthsToBeBetween(
        meta={"check_id": "contract:billing_history:notes:max_length"},
        column="notes",
        max_value=200,
    )
)
...
suite.add_expectation(
    gx.expectations.ExpectColumnToExist(
        meta={"check_id": "contract:billing_history:creationby:exists"},
        column="creationby",
    )
)
suite.add_expectation(
    gx.expectations.ExpectColumnValueLengthsToBeBetween(
        meta={"check_id": "contract:billing_history:creationby:max_length"},
        column="creationby",
        max_value=128,
    )
)
...
suite.add_expectation(
    gx.expectations.ExpectColumnToExist(
        meta={"check_id": "contract:billing_history:updateby:exists"},
        column="updateby",
    )
)
suite.add_expectation(
    gx.expectations.ExpectColumnValueLengthsToBeBetween(
        meta={"check_id": "contract:billing_history:updateby:max_length"},
        column="updateby",
        max_value=128,
    )
)

# Freshness (24h) for billing and payment records (billing_history.creationdate)
suite.add_expectation(
    gx.expectations.ExpectColumnValuesToBeBetween(
        meta={"check_id": "contract:billing_history:creationdate:freshness_24h"},
        column="creationdate",
        min_value=cutoff_24h,
        max_value=now,
    )
)
...
suite.add_expectation(
    gx.expectations.ExpectColumnMinToBeBetween(
        meta={"check_id": "contract:billing_plans:id:min"},
        column="id",
        min_value=1,
    )
)
...
# Generic maxLength checks for other billing_plans string columns with constraints
for col, max_len in [
    ("planType", 128),
    ("planBandwidthUp", 128),
...
suite.add_expectation(
    gx.expectations.ExpectColumnMinToBeBetween(
        meta={"check_id": "contract:financial_summary:id:min"},
        column="id",
        min_value=1,
    )
)
...
for col in ["total", "num_trans", "num_customers"]:
    ...
    suite.add_expectation(
        gx.expectations.ExpectColumnMinToBeBetween(
            meta={"check_id": f"contract:financial_summary:{col}:min"},
            column=col,
            min_value=0,
        )
    )
...
suite.add_expectation(
    gx.expectations.ExpectColumnMinToBeBetween(
        meta={"check_id": "contract:invoice:id:min"},
        column="id",
        min_value=1,
    )
)
...
for col in ["amount", "tax_amount", "total", "discount"]:
    suite.add_expectation(
        gx.expectations.ExpectColumnMinToBeBetween(
            meta={"check_id": f"contract:invoice:{col}:min"},
            column=col,
            min_value=0,
        )
    )
...
suite.add_expectation(
    gx.expectations.ExpectColumnToExist(
        meta={"check_id": "contract:invoice:notes:exists"},
        column="notes",
    )
)
suite.add_expectation(
    gx.expectations.ExpectColumnValueLengthsToBeBetween(
        meta={"check_id": "contract:invoice:notes:max_length"},
        column="notes",
        max_value=128,
    )
)
...
# Custom rule: total == amount + tax_amount - discount (tolerance ±0.01)
suite.add_expectation(
    gx.expectations.ExpectMulticolumnSumToEqual(
        meta={"check_id": "contract:invoice:total:amount_tax_discount_balance"},
...
suite.add_expectation(
    gx.expectations.ExpectColumnMinToBeBetween(
        meta={"check_id": "contract:invoice_status:id:min"},
        column="id",
        min_value=1,
    )
)
...
suite.add_expectation(
    gx.expectations.ExpectColumnMinToBeBetween(
        meta={"check_id": "contract:payment:id:min"},
        column="id",
        min_value=1,
    )
)
...
suite.add_expectation(
    gx.expectations.ExpectColumnMinToBeBetween(
        meta={"check_id": "contract:payment:amount:gt_zero"},
        column="amount",
        min_value=0,
        strict_min=True,
    )
...
# Freshness (24h) for payment.date
suite.add_expectation(
    gx.expectations.ExpectColumnValuesToBeBetween(
...
# Referential integrity (invoice_id -> invoice.id) via query comparison
suite.add_expectation(
...
suite.add_expectation(
    gx.expectations.ExpectColumnMinToBeBetween(
        meta={"check_id": "contract:payment_type:id:min"},
        column="id",
        min_value=1,
    )
)
...
suite.add_expectation(
    gx.expectations.ExpectColumnMinToBeBetween(
        meta={"check_id": "contract:prepaid_transaction:id:min"},
        column="id",
        min_value=1,
    )
)
...
suite.add_expectation(
    gx.expectations.ExpectColumnMinToBeBetween(
        meta={"check_id": "contract:prepaid_transaction:bounce:min"},
        column="bounce",
        min_value=0,
    )
)
...
# Custom rule: due_date >= DATE(creationdate) (use query comparison)
suite.add_expectation(
    gx.expectations.ExpectQueryResultsToMatchComparison(
...
suite.add_expectation(
    gx.expectations.ExpectColumnMinToBeBetween(
        meta={"check_id": "contract:tblcampaign:id:min"},
        column="id",
        min_value=1,
    )
)
...
suite.add_expectation(
    gx.expectations.ExpectColumnValuesToBeBetween(
        meta={"check_id": "contract:tblcampaign:value:range"},
        column="value",
        min_value=0,
        max_value=1,
    )
...
suite.add_expectation(
    gx.expectations.ExpectColumnMinToBeBetween(
        meta={"check_id": "contract:tblcampaign:period:min"},
        column="period",
        min_value=0,
    )
)

for col in ["note", "creationby", "updateby"]:
    suite.add_expectation(
        gx.expectations.ExpectColumnToExist(
    ...
    suite.add_expectation(
        gx.expectations.ExpectColumnValueLengthsToBeBetween(
            ...
            column=col,
            max_value=(128 if col in ["creationby", "updateby"] else 255),
        )
    )

# Custom rule: cend is null OR cstart is null OR cend >= cstart
suite.add_expectation(
    gx.expectations.ExpectQueryResultsToMatchComparison(
        meta={"check_id": "contract:tblcampaign:cend:gte_cstart_when_present"},
        query="""
            SELECT COUNT(*) AS invalid_count
            FROM tblcampaign
            WHERE cend IS NOT NULL
              AND cstart IS NOT NULL
              AND cend < cstart
        """,
        comparison_operator="==",
        expected_value=0,
...
suite.add_expectation(
    gx.expectations.ExpectColumnMinToBeBetween(
        meta={"check_id": "contract:tblgeneration:gid:min"},
        column="gid",
        min_value=1,
    )
)
...
suite.add_expectation(
    gx.expectations.ExpectColumnMinToBeBetween(
        meta={"check_id": "contract:tbllinetype:id:min"},
        column="id",
        min_value=1,
    )
)
...
suite.add_expectation(
    gx.expectations.ExpectColumnMinToBeBetween(
        meta={"check_id": "contract:tbllinetransactions:id:min"},
        column="id",
        min_value=1,
    )
)
